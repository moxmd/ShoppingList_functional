basket = []
# Define a dictionary called 'products' that contains four categories of appliances
...
def display_basket() -> None:
    ...
    if not basket:
        ...
        for item in basket:
            print(f"- {item['name']} - {item['price']} dollars")
...
while True:
    ...
    if choice == '1' :
        ...
        print() # add a space after the selection
        print() # add a space after the selection
        ...
        item_index = int(input("Enter the index of the item to move: "))
